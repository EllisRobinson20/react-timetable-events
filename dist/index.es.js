...
var EventPreview = function (_a) {
    ...
    return (createElement("div", __assign({}, defaultAttributes, { title: event.name, key: event.id }),
        ...
        jsxs("span", __assign({ className: classNames.event_info }, { children: [event.startTime.format("HH:mm"), " - ", event.endTime.format("HH:mm")] }), void 0)));
};
...
export { EventPreview, EventsList, HourPreview, HoursList, TimeTable, getDefaultDayLabel };
