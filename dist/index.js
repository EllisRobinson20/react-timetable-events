...
var css_248z = ".styles_time_table_wrapper__1-rtp {\n  height: 100%;\n  margin: 0;\n  font-family: 'Open Sans', sans-serif;\n  color: #000000;\n  overflow: hidden;\n}\n\n.styles_day__1cspH {\n  position: relative;\n  height: 100vh;\n  float: left;\n  background-color: #2b2b2b;\n  background-image: linear-gradient(rgba(0,0,0,.08) 50%, transparent 50%);\n}\n\n.styles_day_title__1y-BE {\n  background-color: #23418e;\n  font-size: .7rem;\n  font-weight: 600;\n  text-transform: uppercase;\n  display: flex;\n  justify-content: center;\n  flex-direction: column;\n  text-align: center;\n  z-index: 2;\n}\n\n.styles_hour__EXCif {\n  background-color: rgba(18, 3, 34,0.9);\n  font-size: 12px;\n  text-align: center;\n  width: 5rem;\n}\n\n.styles_event__2jA91 {\n  position: absolute;\n  width: 100%;\n  height: 15vh;\n  line-height: 15vh;\n  background-color: rgb(18, 205, 177);\n  font-size: .7em;\n  font-weight: 300;\n  justify-content: center;\n  display: flex;\n  flex-direction: column;\n  overflow: hidden;\n}\n\n.styles_event_info__174ul {\n  line-height: initial;\n  text-align: center;\n}";
var classNames = {"time_table_wrapper":"styles_time_table_wrapper__1-rtp","day":"styles_day__1cspH","day_title":"styles_day_title__1y-BE","hour":"styles_hour__EXCif","event":"styles_event__2jA91","event_info":"styles_event_info__174ul"};
...
var EventPreview = function (_a) {
    ...
    return (React.createElement("div", __assign({}, defaultAttributes, { title: event.name, key: event.id }),
        ...
        jsxRuntime.jsxs("span", __assign({ className: classNames.event_info }, { children: [event.startTime.format("HH:mm"), " - ", event.endTime.format("HH:mm")] }), void 0)));
};
...
var DayColumnPreview = function (_a) {
    ...
    return (jsxRuntime.jsxs("div", __assign({ className: classNames.day + " " + day, style: {
        ...
        } }, { children: [jsxRuntime.jsx("div", __assign({ className: classNames.day_title, style: { height: rowHeight + "vh" } }, { children: getDayLabel(day) }), void 0), EventsList({
                events: events,
                day: day,
